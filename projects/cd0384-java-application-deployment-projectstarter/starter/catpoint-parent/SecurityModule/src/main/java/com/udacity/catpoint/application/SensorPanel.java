...
import com.udacity.catpoint.service.security.SecurityService;
import com.udacity.catpoint.service.security.StyleService;
...
public class SensorPanel extends JPanel implements StatusListener {
    ...
    /**
     * Remove a sensor from the securityService and rebuild the sensor list
